...
# Let us apply a linear nu-SVM (see the documentation for parameters)
print()
print('learning with a {}-sized dataset...'.format(data_size))
classifier = sklearn.svm.NuSVC(nu=0.1, kernel='linear', tol=1e-3, decision_function_shape='ovr')
...
outfile = open('classifier-nu-svm.pkl','wb')
